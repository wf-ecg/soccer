...
Ui.Pointer.prototype.createElement = function (parentEl) {
    ...
    if (this.options.type == 'Arc') {
        ...
        this.el = new Ui.El[this.options.type](this.options.pointerWidth, this.options.pointerHeight, this.width / 2, this.options.pointerHeight / 2 + this.options.offset);
    }
...
Ui.Scale.prototype.createElement = function (parentEl) {
    ...
    if (this.options.drawScale) {
        if (!this.options.labels) {
            ...
            for (i = 0; i < end; i++) {
                rect = new Shape(this.options.tickWidth, this.options.tickHeight, this.width / 2, this.options.tickHeight / 2);
...
Ui.Scale.prototype.dial = function () {
    ...
    if (!this.options.labels) {
        for (i = 0; i < end; i++) {
            text = new Ui.El.Text(Math.abs(min + dialStep * i), this.width / 2 - 2.5, this.height / 2 - this.options.radius, 5, 5);
            this.el.append(text);
        ...
        for (i = 0; i < this.options.labels.length; i++) {
            ...
            text = new Ui.El.Text(label, this.width / 2 - 2.5, this.height / 2 - this.options.radius, 5, 5);
            this.el.append(text);
            text.rotate(this.startAngle + i * step, this.width / 2, this.height / 2);
